        ...
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "center", width: "50%", marginLeft: "25%" }}>
                <div className="f4 dark-gray fw3 lh-copy lekton" style={{ textAlign: "left" }}>
                    <p style={{ textAlign: "left" }}><strong>Description :</strong> There is a ERC 20 token named secops, read the code and execute as per hint.</p>
            
                    <p style={{ textAlign: "left" }}><strong>Hint :</strong> Find the address of deployed contract and get the balance of the owner's wallet. Smart Contract deployment address is <strong>0xa23ce0ca6bd58f779c0f8e9c0e513c80a79a8350198dcab7cafec7415cdc01b6</strong></p>
                    ...
                    <li>Load the contract by selecting load at address in remix.</li>
